...
class SteganoHide(SecurityTool):
    TITLE = "SteganoHide"
...
class StegnoCracker(SecurityTool):
    TITLE = "StegnoCracker"
...
class StegoCracker(SecurityTool):
    TITLE = "StegoCracker"
...
class SteganographyTools(SecurityToolsCollection):
